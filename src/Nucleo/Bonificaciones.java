...
public class Bonificaciones {
  ...
  public Bonificaciones() {
    ...
    TablaBonificaciones[Fasero][Dudu] = 1.5;
    ...
    TablaBonificaciones[Fasero][Josito] = 0.5;
    TablaBonificaciones[Fasero][Miranda] = 1;
    TablaBonificaciones[Fasero][Misswey] = 1;
    TablaBonificaciones[Fasero][Noel] = 1.5;
    TablaBonificaciones[Fasero][Noelia] = 0.5;
    TablaBonificaciones[Fasero][Peybol] = 1.5;
    TablaBonificaciones[Fasero][Ryharuk] = 1;
    TablaBonificaciones[Fasero][Sulo] = 0.5;
    TablaBonificaciones[Jatopelado][Adri] = 1;
    TablaBonificaciones[Jatopelado][Dudu] = 1;
    TablaBonificaciones[Jatopelado][Esteban] = 0.5;
    ...
    TablaBonificaciones[Jatopelado][Josito] = 1.5;
    TablaBonificaciones[Jatopelado][Miranda] = 0.5;
    TablaBonificaciones[Jatopelado][Misswey] = 1;
    TablaBonificaciones[Jatopelado][Noel] = 1.5;
    TablaBonificaciones[Jatopelado][Noelia] = 1.5;
    TablaBonificaciones[Jatopelado][Peybol] = 1;
    TablaBonificaciones[Jatopelado][Ryharuk] = 0.5;
    TablaBonificaciones[Jatopelado][Sulo] = 1;
    TablaBonificaciones[Javier][Adri] = 1.5;
    TablaBonificaciones[Javier][Dudu] = 1;
    TablaBonificaciones[Javier][Esteban] = 0.5;
    TablaBonificaciones[Javier][Fasero] = 1;
    TablaBonificaciones[Javier][Jatopelado] = 1;
    TablaBonificaciones[Javier][Javier] = 1;
    TablaBonificaciones[Javier][Josito] = 1.5;
    TablaBonificaciones[Javier][Miranda] = 0.5;
    TablaBonificaciones[Javier][Misswey] = 1;
    TablaBonificaciones[Javier][Noel] = 0.5;
    TablaBonificaciones[Javier][Noelia] = 1;
    TablaBonificaciones[Javier][Peybol] = 1;
    TablaBonificaciones[Javier][Ryharuk] = 1;
    TablaBonificaciones[Javier][Sulo] = 1.5;
    TablaBonificaciones[Josito][Adri] = 1;
    TablaBonificaciones[Josito][Dudu] = 1;
    TablaBonificaciones[Josito][Esteban] = 1.5;
    TablaBonificaciones[Josito][Fasero] = 0.5;
    TablaBonificaciones[Josito][Jatopelado] = 0.5;
    TablaBonificaciones[Josito][Javier] = 1.5;
    TablaBonificaciones[Josito][Josito] = 1;
    TablaBonificaciones[Josito][Miranda] = 1.5;
    TablaBonificaciones[Josito][Misswey] = 0.5;
    ...
    TablaBonificaciones[Misswey][Josito] = 1.5;
    TablaBonificaciones[Misswey][Miranda] = 1;
    TablaBonificaciones[Misswey][Misswey] = 1;
    TablaBonificaciones[Misswey][Noel] = 1;
    TablaBonificaciones[Misswey][Noelia] = 0.5;
    TablaBonificaciones[Misswey][Peybol] = 1.5;
    TablaBonificaciones[Misswey][Ryharuk] = 0.5;
    TablaBonificaciones[Misswey][Sulo] = 1.5;
    TablaBonificaciones[Noel][Adri] = 1;
    TablaBonificaciones[Noel][Dudu] = 0.5;
    TablaBonificaciones[Noel][Esteban] = 1;
    TablaBonificaciones[Noel][Fasero] = 0.5;
    TablaBonificaciones[Noel][Jatopelado] = 1.5;
    TablaBonificaciones[Noel][Javier] = 1.5;
    TablaBonificaciones[Noel][Josito] = 1;
    TablaBonificaciones[Noel][Miranda] = 1.5;
    TablaBonificaciones[Noel][Misswey] = 1;
    TablaBonificaciones[Noel][Noel] = 1;
    TablaBonificaciones[Noel][Noelia] = 1;
    TablaBonificaciones[Noel][Peybol] = 0.5;
    TablaBonificaciones[Noel][Ryharuk] = 1;
    TablaBonificaciones[Noel][Sulo] = 1;
    TablaBonificaciones[Noelia][Adri] = 1;
    TablaBonificaciones[Noelia][Dudu] = 1.5;
    TablaBonificaciones[Noelia][Esteban] = 1.5;
    TablaBonificaciones[Noelia][Fasero] = 1.5;
    TablaBonificaciones[Noelia][Jatopelado] = 0.5;
    TablaBonificaciones[Noelia][Javier] = 1;
    TablaBonificaciones[Noelia][Josito] = 1;
    TablaBonificaciones[Noelia][Miranda] = 1;
    TablaBonificaciones[Noelia][Misswey] = 0.5;
    ...
    TablaBonificaciones[Noelia][Sulo] = 0.5;
    TablaBonificaciones[Peybol][Adri] = 1;
    TablaBonificaciones[Peybol][Dudu] = 0.5;
    TablaBonificaciones[Peybol][Esteban] = 1;
    TablaBonificaciones[Peybol][Fasero] = 1.5;
    ...
    TablaBonificaciones[Peybol][Misswey] = 0.5;
    TablaBonificaciones[Peybol][Noel] = 1.5;
    TablaBonificaciones[Peybol][Noelia] = 1;
    TablaBonificaciones[Peybol][Peybol] = 1;
    TablaBonificaciones[Peybol][Ryharuk] = 1.5;
    TablaBonificaciones[Peybol][Sulo] = 0.5;
    TablaBonificaciones[Ryharuk][Adri] = 1.5;
    TablaBonificaciones[Ryharuk][Dudu] = 1;
    TablaBonificaciones[Ryharuk][Esteban] = 0.5;
    TablaBonificaciones[Ryharuk][Fasero] = 1;
    TablaBonificaciones[Ryharuk][Jatopelado] = 0.5;
    TablaBonificaciones[Ryharuk][Javier] = 1;
    TablaBonificaciones[Ryharuk][Josito] = 1;
    TablaBonificaciones[Ryharuk][Miranda] = 1.5;
    TablaBonificaciones[Ryharuk][Misswey] = 1.5;
    TablaBonificaciones[Ryharuk][Noel] = 1;
    TablaBonificaciones[Ryharuk][Noelia] = 1;
    TablaBonificaciones[Ryharuk][Peybol] = 0.5;
    TablaBonificaciones[Ryharuk][Ryharuk] = 1;
    TablaBonificaciones[Ryharuk][Sulo] = 1;
    TablaBonificaciones[Sulo][Adri] = 0.5;
    TablaBonificaciones[Sulo][Dudu] = 1;
    TablaBonificaciones[Sulo][Esteban] = 1;
    TablaBonificaciones[Sulo][Fasero] = 1.5;
    TablaBonificaciones[Sulo][Jatopelado] = 1;
    TablaBonificaciones[Sulo][Javier] = 0.5;
    TablaBonificaciones[Sulo][Josito] = 1;
    TablaBonificaciones[Sulo][Miranda] = 1;
    TablaBonificaciones[Sulo][Misswey] = 1.5;
    TablaBonificaciones[Sulo][Noel] = 1;
    TablaBonificaciones[Sulo][Noelia] = 1.5;
    TablaBonificaciones[Sulo][Peybol] = 0.5;
